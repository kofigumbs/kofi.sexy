...
## Game of Life animated SVG ([source](https://github.com/hkgumbs/rc/blob/master/src/Cgol.elm))
...
## Flossing character animated SVG ([source](https://github.com/hkgumbs/rc/blob/master/src/Floss.elm))
...
## Dancing Bitmoji ([source](https://github.com/hkgumbs/rc/blob/master/src/Warp.elm) / [talk](talk/bitmoji-webgl-elm))
...
## Airtable Proxy API ([source](https://github.com/hkgumbs/airtable-app-proxy))
...
## Find Tweets ([source](https://github.com/hkgumbs/find-tweets) / [website](https://findtweets.herokuapp.com))
...
## Live MIDI dancer ([source](https://github.com/hkgumbs/rc/blob/master/src/Visualizer.elm))
...
<iframe src="https://www.youtube.com/embed/cVfDM_I8MDU" frameborder="0" allowfullscreen></iframe>
